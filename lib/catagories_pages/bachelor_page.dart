...
import 'package:find_home/favourites_page/favourites_provider.dart'; // Update as necessary

class BachelorsPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Bachelors Houses')),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('homes')
            .where('houseType', isEqualTo: 'Bachelor Seat')
            .snapshots(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(child: Text('No bachelor houses available.'));
          }

          final bachelorHomes = snapshot.data!.docs;
          ...
          return GridView.builder(
            ...
            itemCount: bachelorHomes.length,
            itemBuilder: (context, index) {
              final homeData = bachelorHomes[index].data() as Map<String, dynamic>;
