...
class SubletPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sublet Houses')),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('homes')
            .where('houseType', isEqualTo: 'Sub-late Room')
            .snapshots(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(child: Text('No sublet houses available.'));
          }

          final subletHomes = snapshot.data!.docs;
          ...
          return GridView.builder(
            ...
            itemCount: subletHomes.length,
            itemBuilder: (context, index) {
              final homeData = subletHomes[index].data() as Map<String, dynamic>;
